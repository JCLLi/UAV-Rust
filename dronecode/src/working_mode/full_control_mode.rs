...
use crate::drone::motors::{angle_to_pwm, motor_assign, motor_assign_full};
...
pub fn velocity_control(drone: &mut Drone, yaw_u16: u16, target_pitch: f32, target_roll: f32) -> [f32; 3]{
   //drone.set_test([target_pitch, target_roll]);
    ...
    [pwm_change[1], pwm_change[2], pwm_change[0]]
