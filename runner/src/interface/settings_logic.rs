        ...
        match self.receiver_keyboard_channel.try_recv() {
            Ok(keyboardcommand) => {
                match keyboardcommand.command {
                    ...
                    Commands::PitchUp               => self.bundle.pitch_offset = self.bundle.pitch_offset.saturating_sub(keyboardcommand.argument as i16),
                    Commands::PitchDown             => self.bundle.pitch_offset = self.bundle.pitch_offset.saturating_add(keyboardcommand.argument as i16),
