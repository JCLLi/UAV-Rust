...
mod tests {
    ...
    fn test_store_json() {
        ...
        for i in 0..10 {
            let datalog = Datalog {motor1: i, motor2: 0, motor3: 0, motor4: 0, rtc: 9, yaw: 0.0, pitch: 0.0, roll: 0.0, x: 0, y: 0, z: 0, bat: 0, bar: 0, workingmode: WorkingModes::ManualMode, arguments: [0, 0, 0, 0] };
